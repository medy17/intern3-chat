...
export function MoonshotAIIcon(props: SVGProps<SVGSVGElement>) {
    return (
...
export function XiaomiIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            <path
                fill="currentColor"
                d="M6.1 0h9.02c2.37 0 4.94.04 6.35 1.46 1.41 1.42 1.45 3.97 1.45 6.35v7.3s0 .08-.01.17c-.02.08-.05.15-.09.19-.14.14-.29.14-.48.14h-3.22c-.36 0-.67-.29-.67-.66V7.54c-.01-1.28-.15-2.51-.62-2.99-.41-.41-1.38-.58-2.46-.61h-5.01s-.25-.01-.36.1c-.11.11-.1.39-.1.39v10.52c0 .37-.31.66-.67.66H6.1c-.36 0-.67-.3-.67-.66V.66C5.43.3 5.74 0 6.1 0zm19.46 0h3.13c.36 0 .67.28.67.66v14.45s0 .26-.07.35c-.09.11-.2.15-.39.15h-3.34c-.36 0-.67-.3-.67-.66V.66c0-.37.31-.66.67-.66zM12.55 5.69h3.29c.36 0 .67.29.67.66v8.6c0 .37-.31.66-.67.66h-3.29c-.36 0-.67-.29-.67-.66v-8.6c0-.37.31-.66.67-.66z"
            />
        </svg>
    )
}
...
export function VercelIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" {...props}>
            <title>Vercel</title>
            <path d="M12 4 20 18H4z" fill="currentColor" />
        </svg>
    )
}
