            ...
            <div className="flex w-full flex-col items-center space-y-4">
                ...
                <div className="space-y-2 text-left">
                    <p className="text-muted-foreground text-xs leading-relaxed">
                        SilkChat has a built-in theme switcher. Try some of the popular ones above!
            ...
            <div className="-mb-12 space-y-6">
                ...
                <div className="-translate-y-10 space-y-3">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        ...
                        any model you want. SilkChat works with all leading models (OpenAI, Gemini,
                        Claude, etc.), and even custom OpenAI-compatible providers.
                    </p>
                </div>
            </div>
        )
        ...
        content: (
            <div className="flex w-full flex-col items-start space-y-4 text-left">
                ...
                <div className="w-full space-y-1">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        Start chatting with AI and make SilkChat truly yours! Don't forget to
